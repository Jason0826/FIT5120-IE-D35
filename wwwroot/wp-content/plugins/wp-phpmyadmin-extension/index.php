...
-->
				...
				<?php if ( !is_ssl() ) { ?>
				<tr>
					<td class="xred_warning"><?php _e("Use HTTPS (so, auto-login will work)", 'wp-phpmyadmin-extension');?> <?php echo $this->question_mark($this->ssl_notice_msg, $dialogType=2);?></td> 
