...
$i++;
$cfg['Servers'][$i]['host'] 			= '127.0.0.1:51042';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= 'P6;]ND#\\bF%t\\Duh[.4l1L|^ltjU/6rq' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_su4WK1rMnpT8zVLPR9NJgwB/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
